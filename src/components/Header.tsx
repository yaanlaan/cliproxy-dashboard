        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="font-bold text-white text-base tracking-tight">CLIProxyAPI</h1>
        ...
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-950/70 border border-slate-800 text-xs">
          {isConnected ? (
            <>
              ...
              <span className="text-emerald-400 font-medium">在线 ({latencyMs}ms)</span>
              {versionInfo && (
            ...
            <>
              ...
              <span className="text-rose-400 font-medium">服务离线</span>
            </>
          )}
        </div>
